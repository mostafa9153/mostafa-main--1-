...
const techStack = [
  {
    name: "n8n",
    icon: Workflow,
    description: "Workflow automation engine orchestrating all integrations and logic flows"
  },
  {
    name: "Voice AI",
    icon: Phone,
    description: "Natural language voice agent handling patient calls 24/7"
  },
  {
    name: "RAG System",
    icon: Database,
    description: "Retrieval-Augmented Generation for smart context-aware responses"
  },
  {
    name: "Calendar API",
    icon: Calendar,
    description: "Real-time calendar sync with Google Calendar and clinic systems"
  }
];

const results = [
  { metric: "40%", label: "Reduction in missed appointments" },
  { metric: "24/7", label: "Automated booking availability" },
  { metric: "0", label: "Manual intervention needed" },
  { metric: "3 min", label: "Average booking completion time" }
];

const VoiceAppointmentCaseStudy = () => {
  return (
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-primary/10 border border-primary/20 mb-8 animate-fade-up">
                ...
                <span className="text-lg font-medium text-primary">Voice Appointment Agent</span>
              </div>
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 animate-fade-up animation-delay-100">
                <span className="text-gradient">40% Reduction</span> in Missed Appointments
              </h1>

              <p className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-up animation-delay-200">
                How an AI-powered voice agent transformed clinic booking operations and eliminated scheduling chaos
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card/50 rounded-3xl border border-border/50 p-8 md:p-12 backdrop-blur-sm
                ...
                <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
                  <p>
                    A busy healthcare clinic was struggling with a critical operational bottleneck:
                    <strong className="text-foreground"> missed calls and manual appointment scheduling</strong> were
                    causing them to lose potential patients and revenue.
                  </p>
                  <p>
                    Their front desk staff was overwhelmed during peak hours, leading to:
                  </p>
                  <ul className="space-y-3 ml-4">
                    <li className="flex items-start gap-3">
                      <span className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>30-40% of incoming calls going unanswered during busy periods</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>Patients forgetting appointments due to lack of automated reminders</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>Double-bookings and scheduling conflicts causing frustration</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>No after-hours booking capability, losing potential patients to competitors</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="bg-card/50 rounded-3xl border border-border/50 p-8 md:p-12 backdrop-blur-sm
                ...
                <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
                  <p>
                    I built a comprehensive <strong className="text-primary">AI-powered Voice Appointment Agent</strong> that
                    handles the entire booking workflow autonomously:
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-8">
                    <div className="p-5 rounded-2xl bg-primary/5 border border-primary/20">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-semibold text-foreground">Voice AI Reception</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        Natural-sounding AI voice agent answers calls, understands patient needs, and handles conversations in multiple languages
                      </p>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-primary/5 border border-primary/20">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Real-time calendar integration that finds optimal slots, prevents double-bookings, and confirms appointments instantly
                      </p>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-primary/5 border border-primary/20">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-semibold text-foreground">Automated Reminders</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        Multi-channel reminders via SMS, WhatsApp, and voice calls 24h and 1h before appointments
                      </p>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-primary/5 border border-primary/20">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-semibold text-foreground">Patient Context</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        RAG-powered system recalls patient history and preferences for personalized interactions
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-card/50 rounded-3xl border border-border/50 p-8 backdrop-blur-sm">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Clinic now operates with 24/7 booking availability without additional staff</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Patient satisfaction scores increased by 35% due to easier booking process</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Front desk staff freed up to focus on in-person patient care</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>ROI achieved within 2 months of deployment</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-3xl border border-primary/20 p-8 md:p-12
                ...
                <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                  Let's discuss how a similar solution can transform your clinic, practice, or business operations
                </p>
...
export default VoiceAppointmentCaseStudy;
